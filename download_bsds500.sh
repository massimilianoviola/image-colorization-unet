#!/bin/bash
# Download the BSDS500 dataset and extract into a training folder
...
TEMP_DIR="./temp_bsds500"
mkdir -p "$TEMP_DIR"

echo "Downloading BSDS500 dataset..."
wget -O "$TEMP_DIR/BSDS500.tgz" "$BSD_URL"

echo "Extracting images..."
tar -xf "$TEMP_DIR/BSDS500.tgz" -C "$TEMP_DIR"
...
echo "Download complete. BSDS500 images are now in ${TRAIN_DIR}"
